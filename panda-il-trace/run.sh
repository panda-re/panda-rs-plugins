...
cargo build && \
    ...
    $PANDA_PATH/x86_64-softmmu/panda-system-x86_64 -os "linux-64-ubuntu:4.15.0-72-generic-noaslr-nokaslr" -replay ../test -panda il_trace:proc_name=${1:-$DEF_PROC},debug=1,trace_lib=1,pretty_json=1 -m 1G
